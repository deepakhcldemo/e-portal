...
import {
  getBlogListFromDBOrCount,
  deleteBlogFromDB
} from './../../../database/dal/firebase/TeacherBlog';
// Color Constant
...
class BList extends Component {
  ...
  getBlogList = () => {
    ...
    getBlogListFromDBOrCount(startAt, itemsPerPage, true).onSnapshot(
      querySnapshot => {
        let blogs = [];
  ...
  render = () => {
    const {
      blogs,
      userDetails,
      viewId /*  activePage, itemsPerPage, totalItemCount */
    } = this.state;
    return (
                  ...
                  blogs.map((blog, index) => {
                    return (
                      <Col sm={12} key={index}>
                        ...
                        >
                          <Card.Body className="blog-description">
                          ...
                          >
                            ...
                            {userDetails &&
                              userDetails.userId === blog.teacherId && (
                                <>
                                  <Button
                                    variant="outline-danger"
                                    onClick={() =>
                                      this.handleClick(blog.id, 'delete')
                                    }
                                  >
