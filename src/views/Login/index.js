...
class Login extends Component {
  ...
  login = () => {
    ...
    if (username && password) {
      axios
        .post(
          "https://jwrr2fa8mf.execute-api.us-east-1.amazonaws.com/p3/login",
          {
            userName: username,
            password: password
          }
        ...
        .then(
          postResponse => {
            if (postResponse.data.status && postResponse.data.status ==='Failure') {
              ...
              this.props.setSpinnerStatus(false);
              postResponse.data["owner"] = username;
