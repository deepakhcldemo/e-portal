              ...
              <div className="col-sm-12">
                <div className="row main-setion">
                  ...
                  <div className="col-sm-9">
                    <div>
                      ...
                      <div
                        className={classnames({ 'disbaled-stars': !isLogedIn })}
                      >
                        <RatingComponent
                          name="rate1"
                          starCount={5}
                ...
                <div className="comment-thread-element">
                  ...
                  <div className="comment-content">
                    ...
                    <p>
                      Is dolor sit amet long established fact that a reader will
                      be distracted by the readable content of a page when
                      looking at its layout. The point of using Lorem Ipsum is
                      that it has a more-or-less normal. Color sit amet long
