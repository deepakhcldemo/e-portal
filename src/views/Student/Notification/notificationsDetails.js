...
import { getNotification, getTeachers, getStudents, getTeacherFromStudentIdFromDB, getStudentNotification } from '../../Teacher/Notification/notificationAction';
                                ...
                                <div className="card-body">
                                    ...
                                    {Object.keys(notificationDetails).map((notificationDetail) => (
                                        ...
                                        <div className={this.getClassName(notificationDetails[notificationDetail].status)}>
                                            <Link to={`/student/notificationsDescription/` + notificationDetails[notificationDetail].nId} activeClassName="active">
                                                <div>
                                                    ...
                                                    <div className="container" onClick={this.onOpenModal} style={{ cursor: "pointer" }}>
                                                        ...
                                                        <div className="alert-icon">
                                                            <i className="material-icons">Teacher {notificationDetails[notificationDetail].tId} </i>
                                                        </div>
                                                        <button type="button" className="close" data-dismiss="alert" aria-label="Close">
                                                            <span aria-hidden="true"><i className="material-icons">clear</i></span>
                                                        </button>
                                                        {console.log("Notification Data Comment : ", notificationDetails[notificationDetail].comment)}
                                                        <b>Message:</b> {notificationDetails[notificationDetail].comment ?
                                                            Object.keys(notificationDetails[notificationDetail].comment).map(data => (
                                                                notificationDetails[notificationDetail].comment[data].details
                                            ...
                                            {notificationDetails[notificationDetail].paymentStatus != false ? <button type="button" className="btn btn-success" data-dismiss="modal">Start Chat</button> : <div></div>}
                                        </div>
                                    ))
                                    }
